...
public class ListDemandViewModel extends ViewModel implements MviViewModel<DemandListIntents, DemandListViewState> {
    ...
    public ListDemandViewModel(Context context, FirebaseDbHelper dbHelper) {
        super();
        mIntentsSubject = PublishSubject.create();
        mStatesObservable = compose();
        mContext = context;
    ...
    protected Observable<DemandListViewState> compose() {
        return mIntentsSubject
            ...
            .scan(DemandListviewStateEmpty.idle(), reducer)
    ...
    private BiFunction<DemandListViewState, DemandListIntents, DemandListViewState> reducer =
